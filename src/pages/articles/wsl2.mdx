...
**Easy export / import**: One concern I had with WSL2 was wondering how challenging it would be to restore your Linux environment if you upgrade computers. I use Microsoft's Surface Pro series as my daily driver, and I was contemplating swapping in a larger SSD, but I was unsure how well the WSL2 export / import functionality would work. Well, I'm happy to report that it worked perfectly -- I exported my Linux distribution, saved it to OneDrive, and then just imported it once the new SSD was installed.
