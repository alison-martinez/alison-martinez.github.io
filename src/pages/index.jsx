    ...
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <ol className="mt-6 space-y-4">
        {education.map((role, roleIndex) => (
          <li key={roleIndex} className="flex gap-4">
            <div className="dark:border-white-700/50 dark:bg-white-800 relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-white dark:ring-0">
      ...
      <ol className="mt-6 space-y-4">
        {resume.map((role, roleIndex) => (
          <li key={roleIndex} className="flex gap-4">
            <div className="dark:border-white-700/50 dark:bg-white-800 relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-white dark:bg-zinc-800 dark:ring-0 dark:ring-0">
              <Image src={role.logo} alt="" className="h-7 w-7" unoptimized />
            </div>
            <dl className="flex flex-auto flex-wrap gap-x-2">
              <dt className="sr-only">Company</dt>
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Alison Adams Martinez, PhD - Software engineer, scientist, and
          furniture enthusiast
        </title>
        <meta
          name="description"
          content="I'm Alison, a full-stack software engineer and management consulting professional with extensive industry experience in genetics,  healthcare, and the life sciences."
        />
      </Head>
