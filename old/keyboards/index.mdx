...
If you want to learn more, there are a wide range of videos available where you can see and hear people typing on every switch type you could possibly imagine. You can also buy switch samplers that will give you a variety of switches to try out before you commit to buying enough to fill a whole keyboard.
